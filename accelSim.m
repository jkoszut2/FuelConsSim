...
% Requirednputs are: 1. Desired distance to travel, 2. initial velocity, 
% and 3. initial gear
% Optional inputs are: 1. A modifier array that can be used for running 
% sweeps on parameters and 2. A boolean to turn on plotting showing various
